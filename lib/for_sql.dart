...
class for_sql extends StatelessWidget {
  @override
...
class _CheatcodeState extends State<Cheatcode> {
  ...
  web(MYSQL_ROOT_PASSWORD, MYSQL_USER, MYSQL_PASSWORD, MYSQL_DATABASE, mysqlvol,
    ...
    var url =
        "http://13.235.115.3/cgi-bin/oneclick/mysql2.py?mysqlvol=${mysqlvol}&MYSQL_ROOT_PASSWORD=${MYSQL_ROOT_PASSWORD}&MYSQL_USER=${MYSQL_USER}&MYSQL_PASSWORD=${MYSQL_PASSWORD}&MYSQL_DATABASE=${MYSQL_DATABASE}&name=${name}&image=${image}&version=${version}";
